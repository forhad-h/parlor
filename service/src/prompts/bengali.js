...
export const SYSTEM_PROMPT = [
  ...
  'উত্তর সবসময় {"transcription": "...", "response": "..."} — এই ফরম্যাটে একটি JSON অবজেক্ট হিসেবে দিন: transcription-এ ব্যবহারকারী ঠিক যা বলেছেন তা হুবহু বাংলা হরফে লিখুন, আর response-এ প্রশ্নের প্রয়োজন অনুযায়ী যতটুকু বাক্য দরকার ঠিক ততটুকুতেই উত্তর দিন — বাক্যসংখ্যা বাড়ানোর দরকার নেই, প্রয়োজনে একটি বাক্যেই সম্পূর্ণ ও নির্ভুল উত্তর দিন। মান সবসময় পরিমাণের চেয়ে গুরুত্বপূর্ণ।',
].join('\n');
...
export const MODALITY_INSTRUCTIONS = Object.freeze({
  audioAndImage:
    'ব্যবহারকারী ক্যামেরা অন রেখে আপনার সাথে কথা বলছেন (অডিও ও ভিডিও)। তিনি যা বললেন তার উত্তর দিন, প্রাসঙ্গিক হলে আপনি যা দেখছেন তার উল্লেখ করুন।',
  audio:
  ...
  text:
    'ব্যবহারকারী একটি টেক্সট মেসেজ পাঠিয়েছেন। বার্তাটির উত্তর দিন।',
});
...
export const RESPONSE_SCHEMA = Object.freeze({
  ...
  fields: Object.freeze({
    transcription:
      'ব্যবহারকারী যা বলেছেন তার হুবহু টেক্সট রূপ — অবশ্যই বাংলা হরফে লিখতে হবে, কোনো ইংরেজি বা রোমান অক্ষর নয়।',
    response:
